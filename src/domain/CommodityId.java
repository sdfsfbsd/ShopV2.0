...
public class CommodityId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CommodityId))
			return false;
		CommodityId castOther = (CommodityId) other;

		return ((this.getIdcommodity() == castOther.getIdcommodity()) || (this.getIdcommodity() != null
				&& castOther.getIdcommodity() != null && this.getIdcommodity().equals(castOther.getIdcommodity())))
