...
public class ShopId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShopId))
			return false;
		ShopId castOther = (ShopId) other;

		return ((this.getIdshop() == castOther.getIdshop()) || (this.getIdshop() != null
				&& castOther.getIdshop() != null && this.getIdshop().equals(castOther.getIdshop())))
