...
public class Commodity  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Commodity(CommodityId id, String commName, String commPrice, String commNumber, String commDescription, String type, Boolean isSold) {
        this.id = id;
    ...
    /** full constructor */
    public Commodity(CommodityId id, String commName, String commPrice, String commNumber, String commDescription, String commPicUrl, String type, Boolean isSold, Set orders) {
        this.id = id;
        this.commName = commName;
        this.commPrice = commPrice;
        this.commNumber = commNumber;
